    ...
    return (
        ...
        <div>
            ...
            <div class="flex h-screen">
                <div class="px-4 py-2 bg-gray-200 bg-white lg:w-1/4">
                    ...
                    <div class="hidden lg:block">
                        ...
                        <ul>
                            ...
                            <li class="mb-2 rounded hover:shadow hover:bg-orange-500 hover:text-white">
                                <a href="#" class="inline-block w-full h-full px-3 py-2 font-bold">
